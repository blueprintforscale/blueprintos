            ...
            {activeTab === 3 && (
              <motion.div variants={item}>
                {historicalLoading ? (
                  ...
                  <HistoricalPerformance data={historicalData} startDate={selectedClientObj?.start_date} trendStartDate={(selectedClientObj as any)?.dashboard_config?.trend_start_date} showSuperQuality={(selectedClientObj as any)?.dashboard_config?.show_super_quality} hiddenMetrics={(selectedClientObj as any)?.dashboard_config?.hidden_trend_metrics} campaignTrend={campaignTrendData} seoTrend={seoTrend} activeSource={activeSource} />
                )}
              </motion.div>
            )}
          </motion.div>
